...
export const SITE_DESCRICAO_PADRAO =
  "Próspera Verde é uma cooperativa de reciclagem e gestão de resíduos sólidos em Itaberaba, Bahia, que ensina a população a reciclar corretamente por meio de simulações interativas.";
